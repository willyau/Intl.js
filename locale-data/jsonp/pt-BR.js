IntlPolyfill.__addLocaleData({
    ...
    date: {
        ...
        formats: [{
            ...
            minute: "2-digit",
            second: "2-digit",
            pattern: "{weekday}, {day} de {month} de {year} {hour}h{minute}:{second}",
            pattern12: "{weekday}, {day} de {month} de {year} {hour}h{minute}:{second} {ampm}"
        }, {
            weekday: "short",
            day: "numeric",
            month: "short",
            ...
            hour: "numeric",
            minute: "2-digit",
            pattern: "{weekday}, {day} de {month} de {year} {hour}h{minute}",
            pattern12: "{weekday}, {day} de {month} de {year} {hour}h{minute} {ampm}"
        }, {
            weekday: "short",
            day: "numeric",
            month: "long",
            ...
            hour: "numeric",
            minute: "2-digit",
            pattern: "{day} de {month} {hour}h{minute}",
            pattern12: "{day} de {month} {hour}h{minute} {ampm}"
        }, {
            day: "numeric",
            month: "numeric",
            pattern: "{day}/{month}"
            ...
            minute: "2-digit",
            second: "2-digit",
            pattern: "{hour}:{minute}h{second}",
            pattern12: "{hour}:{minute}h{second} {ampm}"
        }, {
            hour: "numeric",
            minute: "2-digit",
            pattern: "{hour}h{minute}",
            pattern12: "{hour}h{minute} {ampm}"
        }],
        calendars: {
            buddhist: {
                eras: {
