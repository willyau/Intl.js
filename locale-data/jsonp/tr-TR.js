IntlPolyfill.__addLocaleData({
    ...
    date: {
        ...
        formats: [{
            ...
            hour: "numeric",
            minute: "2-digit",
            pattern: "{day} {month} {year} {weekday} {hour}:{minute}",
            pattern12: "{day} {month} {year} {weekday} {ampm}{hour}:{minute}"
        }, {
            day: "numeric",
            month: "short",
            year: "numeric",
            ...
            pattern12: "{day} {month} {ampm}{hour}:{minute}"
        }, {
            day: "2-digit",
            month: "2-digit",
            pattern: "{day}/{month}"
