IntlPolyfill.__addLocaleData({
    ...
    date: {
        ...
        formats: [{
            ...
            hour: "numeric",
            minute: "2-digit",
            pattern: "{year}年{month}月{day}日{weekday} {hour}:{minute}",
            pattern12: "{year}年{month}月{day}日{weekday} {ampm}{hour}:{minute}"
        }, {
            year: "numeric",
            month: "numeric",
            day: "numeric",
            ...
            hour: "numeric",
            minute: "2-digit",
            pattern: "{month}{day}日 {hour}:{minute}",
            pattern12: "{month}{day}日 {ampm}{hour}:{minute}"
        },{
            month: "numeric",
            day: "numeric",
            pattern: "{month}/{day}"
