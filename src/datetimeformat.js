...
function/* 12.1.1.1 */InitializeDateTimeFormat (dateTimeFormat, requestedLocales, options, internal) {
    ...
    //      internal property of DateTimeFormat, and localeData.
        r = LOCALE.ResolveLocale(DateTimeFormat['[[availableLocales]]'], requestedLocales,
...
/* 12.2.2 */defineProperty(Intl.DateTimeFormat, 'supportedLocalesOf', {
    configurable: true,
    writable: true,
    value: fnBind.call(LOCALE.supportedLocalesOf, internals.DateTimeFormat)
});
    ...
    for (var p in dateTimeComponents) {
        ...
        if (hop.call(internal, '[['+ p +']]')) {
            ...
            if (f === 'numeric')
                ...
                fv = NF.FormatNumber(nf, v);

            // viii. Else if f is "2-digit", then
            else if (f === '2-digit') {
                // 1. Let fv be the result of calling the FormatNumber abstract operation
                //    with arguments nf2 and v.
                fv = NF.FormatNumber(nf2, v);
...
Intl.__localeSensitiveProtos.Date = {};

/**
 * When the toLocaleString method is called with optional arguments locales and options,
 * the following steps are taken:
 */
/* 13.3.1 */Intl.__localeSensitiveProtos.Date.toLocaleString = function () {
 ...
 */
/* 13.3.2 */Intl.__localeSensitiveProtos.Date.toLocaleDateString = function () {
    // Satisfy test 13.3.0_1
    if (Object.prototype.toString.call(this) !== '[object Date]')
 ...
 * options, the following steps are taken:
 */
/* 13.3.3 */Intl.__localeSensitiveProtos.Date.toLocaleTimeString = function () {
    // Satisfy test 13.3.0_1
    if (Object.prototype.toString.call(this) !== '[object Date]')
